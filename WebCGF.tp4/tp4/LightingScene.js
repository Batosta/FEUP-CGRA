...
class LightingScene extends CGFscene 
{
	...
	init(application) 
	{
		...
		this.cylinder1 = new MyCylinder(this, 20, 3);
		this.cylinder2 = new MyCylinder(this, 20, 3);
		...
		this.cylinder1Appearence = new CGFappearance(this);
		this.cylinder1Appearence.setAmbient(0.2,0.2,0.2,1);
		this.cylinder1Appearence.setDiffuse(0.8,0.8,0.8,1);
		this.cylinder1Appearence.setSpecular(0.1,0.1,0.1,1);
		this.cylinder1Appearence.setShininess(1);
		this.cylinder1Appearence.loadTexture("../resources/images/aviario.png");

		this.cylinder2Appearence = new CGFappearance(this);
		this.cylinder2Appearence.setAmbient(0.2,0.2,0.2,1);
		this.cylinder2Appearence.setDiffuse(0.8,0.8,0.8,1);
		this.cylinder2Appearence.setSpecular(0.1,0.1,0.1,1);
		this.cylinder2Appearence.setShininess(1);
		this.cylinder2Appearence.loadTexture("../resources/images/deslocas.png");
	...
	display() 
	{
		...
		this.pushMatrix();
			...
			this.translate(3, 12, -10);
			this.scale(1, 1, 10);
			//this.cylinder1Appearence.apply();
